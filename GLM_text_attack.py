...
with open(os.path.join(output_dir, "GLM-4.1V-9B-Thinking.json"), "w", encoding="utf-8") as f:
    json.dump(results, f, ensure_ascii=False, indent=4)

print(f"处理完成，结果已保存到 {os.path.join(output_dir, 'GLM-4.1V-9B-Thinking.json')}")
